  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="./gambar/logo.jpg" alt="" width="50" height="50" class="me-2" />
            ...
            ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="hapus.php?idp=<?php echo $row['id_mobil'] ?>" onclick="return confirm('Yakin Ingin Hapus ?'
                                )"><button type="button" class="btn btn-warning">Hapus</button></a>
                    <a href="hapus.php?idp=<?php echo $row['id_mobil'] ?>" onclick="return confirm('Yakin Ingin Hapus ?'
    ...
    <div class="container">
      <div class="row mt-2">
        <div class="col-md-6 text-md-start text-center pt-2 pb-2">
          ...
          <span class="ps-1">Copyright @2022 | created by
